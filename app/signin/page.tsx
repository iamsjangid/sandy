        ...
        <div className='w-full h-full flex justify-between '>
            ...
            <Formik initialValues={initialValues} onSubmit={onSubmitHandler} validationSchema={validationSchema}>
                <Form className="min-h-screen w-full px-24 py-24 ">
                    ...
                    <div className="my-1 flex justify-end items-center w-[40%] ">
                            <Link className='underline font-light' href={"/forget"}>Forget</Link>
                        </div>
                    <div className="mb-3 w-[40%] ">
                    ...
                    <div className="py-10 w-[40%]">
                        <p className='w-full text-center text-sm '>Don{"'"}t have an account? <Link className='underline' href={"/signup"}>Sign Up</Link></p>
                    </div>
                </Form>
            </Formik>
